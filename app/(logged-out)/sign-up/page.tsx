...
const formSchema = z.object({
  ...
  numberofEmloyees: z.coerce.number().optional(),
  ...
  password: z.string()
    ...
    }, "Password must contain atleast 1 special character and 1 uppercase letter"),
  ...
  if (data.accountType === "company" && (!data.numberofEmloyees || data.numberofEmloyees < 1)) {
    ctx.addIssue({
      code: z.ZodIssueCode.custom,
      path: ["numberofEmloyees"],
